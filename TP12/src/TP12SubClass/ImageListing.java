...
public class ImageListing extends GenralNeededMethod{
    ...
    // private static void listAllImageIgnoreInfo(){
    //     ImageORM imageORM=new ImageORM();
    //     var images =imageORM.listAll();
    //     System.out.println("---------- Images ----------");
    //     System.out.printf("%-6s %-12s %s\n", "ID", "HotelID", "ImagePath");
    //     for(Image i: images){
    //         System.out.printf("%-6d %-12d %s\n", i.getId(), 
    //                                                     i.getHotel()==null?"Deleted":i.getHotel().getId(), 
    //                                                     i.getImagePath());
    //     }
    // }
