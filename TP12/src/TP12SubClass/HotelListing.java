...
public class HotelListing extends GenralNeededMethod {
    ...
    //this will display detail and even if the country/city no loonger in list, will replace by Delteded
