...
public class UserListing extends GenralNeededMethod {

    public static void main(String[] args) throws SQLException {
        create_database(DB);
        DbManager.getInstance(DB, "root", null);
        int opt;
        if(!superUser){System.out.println(">Permission denied");
    ...
    private static void addNewUser(){
        ...
        if(foundrole.size()>0){
            ...
            if(user.getUsername().length()<3){System.out.println("Username must be 3 characer or more!");return;}
            ...
            if(pass.equals("")){System.out.println(">>>>Password can not be emplty");return;}
