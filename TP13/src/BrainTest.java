    ...
    public static void main(String[] args) {
        ...
        while((countCorrect+countWrong)!=10){
            ...
            if(brainTest.getResultInput().equals("")){
                System.out.println("You finished "+(countCorrect+countWrong)+" test"+((countCorrect+countWrong)>1?"s":""));
                break;
        ...
        if(countCorrect+countWrong==10) System.out.println("Congrat!!! You have finished all the tests");
